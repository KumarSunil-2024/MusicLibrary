...
function ManageSongs() {
  ...
  // 2. EXPLICIT API FETCH (Simple to read and explain)
  ...
  return (
    <div className="container py-3" style={{ color: "#2c3e50" }}>
      ...
      <div className="p-3 mb-3 border shadow-sm d-flex flex-column flex-sm-row justify-content-between align-items-sm-center bg-light gap-2" style={{ borderRadius: "10px" }}>
        <div>
          <h4 className="fw-bold m-0">📁 Global Catalog Configuration</h4>
          <small className="text-muted">Manage song fields using image URLs.</small>
        </div>
        <div>
      ...
      <div className="row g-3">
        ...
        <div className="col-lg-4">
          <form onSubmit={saveTrack} className="card p-3 shadow-sm border bg-white" style={{ borderRadius: "10px" }}>
            ...
            <div className="d-flex flex-column gap-2" style={{ fontSize: "0.82rem" }}>
              ...
              {["songName", "singer", "albumName", "musicDirector", "songUrl", "image"].map((field) => (
                <div key={field}>
                  <label className="text-muted fw-semibold small text-capitalize">
                    {field.replace("Name", " Title").replace("Url", " Link").replace("image", "Artwork Image URL")}
                  </label>
                  <input 
                    type="text" 
                    name={field} 
              ...
              <div className="d-flex gap-2 mt-2">
                <button type="submit" className={`btn btn-sm fw-bold flex-grow-1 ${editId ? "btn-warning" : "btn-success"}`}>
        ...
        <div className="col-lg-8">
          <div className="card border shadow-sm" style={{ borderRadius: "10px", overflow: "hidden" }}>
            ...
            <div className="card-body p-0 bg-white" style={{ maxHeight: "465px", overflowY: "auto" }}>
                        ...
                        <td className="ps-3">
                          <div className="d-flex align-items-center gap-2">
                            <img 
                              ...
                              alt="" 
                              style={{ width: "34px", height: "34px", borderRadius: "5px", objectFit: "cover" }} 
                            />
                            <div style={{ minWidth: 0 }}>
                              <p className="mb-0 fw-bold text-truncate" style={{ maxWidth: "180px" }}>{item.songName || "Untitled Track"}</p>
                              <small className="text-muted text-truncate d-block" style={{ maxWidth: "180px" }}>{item.singer || "Unknown Artist"}</small>
                            </div>
                          </div>
                        </td>
